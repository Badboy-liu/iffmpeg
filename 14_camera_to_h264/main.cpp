...
int main(int argc, char* arg[])
{
    ...
    const char* deviceName = "video=ACER HD User Facing:audio=麦克风阵列 (适用于数字麦克风的英特尔® 智音技术)";

    if (avformat_open_input(&inFmtCtx, deviceName, inFmt, NULL) < 0) {
    ...
    outCodecPara->width = 592;
    outCodecPara->height = 1280;
